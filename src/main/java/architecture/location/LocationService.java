...
public class LocationService {
    public List<Country> getCountries(List<FlatLocation> locations) {
    ...
    private static List<State> getStates(List<FlatLocation> locations, Country country) {
    ...
    private static List<City> getCities(List<FlatLocation> locations, State state) {
